    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="text-sm text-ink-secondary">
          ...
          <Select
            {...register("attendanceRange")}
            aria-invalid={!!errors.attendanceRange}
            defaultValue=""
            className="mt-1"
          >
      ...
      <label className="text-sm text-ink-secondary">
        ...
        <span className="text-ink-muted">
          (optional -- e.g. YouTube, Podcast, Blog)
        </span>
        <Input {...register("contentPlatforms")} className="mt-1" />
      </label>

      <label className="text-sm text-ink-secondary">
        What would you like Ruach to help with?{" "}
        <span className="text-ink-muted">(optional)</span>
      ...
      <button
        ...
        className={`${buttonClasses("primary", "md")} mt-2 justify-center`}
      >
        {isSubmitting ? (
          <>
