...
export function ProcessTimeline() {
  return (
    <section className="bg-paper px-5 py-28 text-ink sm:px-8 sm:py-36">
      <div className="mx-auto max-w-editorial">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            href="/the-experience"
            className="inline-flex items-center gap-2 border-b border-ink/30 pb-1 font-sans text-[0.72rem] uppercase tracking-label transition-colors hover:border-ink"
          >
        ...
        <ol className="mt-16 border-t border-ink/10">
          {STEPS.map((step) => (
            <li key={step.n} className="border-b border-ink/10">
              <motion.div
